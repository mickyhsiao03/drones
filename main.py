...
def move_top_right():
    if facing_north():
        ...
        turn_right()
        move()
        droneCommands.extend(("forward x", "right x"))
    elif facing_east():
        move()
        turn_left()
        move()
        droneCommands.extend(("foward x", "left x"))
    elif facing_south():
        turn_left()
        move()
        turn_left()
        move()
        droneCommands.extend(("left x", "backward x"))
    elif facing_west():
        turn_right()
        move()
        turn_right()
        move()
        droneCommands.extend(("right x", "backward x"))
    
def move_right():
    if facing_north():
        turn_right()
        move()
        droneCommands.append(("right x"))
    elif facing_east():
        move()   
        droneCommands.append(("foward x"))
    elif facing_south():
        turn_left()
        move()
        droneCommands.append(("left x"))
    elif facing_west():
        turn_back()
        move()
        droneCommands.append(("backward x"))
def move_bot_right():
    if facing_north():
        turn_back()
        move()
        ...
        turn_left()
        move()
        droneCommands.extend(("right x", "forward x"))
    elif facing_south():
        move()
        turn_left()
        move()
...
def move_bot_left():
    if facing_north():
        ...
        turn_right()
        move()
        droneCommands.extend(("backward x", "left x"))
    elif facing_east():
        turn_right()
        move()
        turn_right()
        ...
        turn_right()
        move()
        droneCommands.extend(("foward x", "right x"))
    elif facing_west():
        turn_left()
        move()
        turn_right()
        move()
        droneCommands.extend(("left x", "forward x"))
def move_left():
    if facing_north():
        turn_left()
        move()
...
def main():
    ...
    with open(f"C:/Users/Micky/Desktop/TelloCommands{curTime}.txt", "w") as f: #writes tello command file with time stamp
